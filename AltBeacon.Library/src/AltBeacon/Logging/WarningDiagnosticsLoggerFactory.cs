// <copyright file="WarningDiagnosticsLoggerFactory.cs" company="Radius Networks, Inc.">
...
{
    /// <summary>
    /// Creates logging interfaces which uses <see cref="System.Diagnostics.Debug"/>
    /// class for logs Warning or higher level.
    /// This class can not be inherited.
    /// </summary>
    public sealed class WarningDiagnosticsLoggerFactory : ILoggerFactory
    {
        /// <summary>
